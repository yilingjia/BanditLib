...
def createNeuralPHEDict(specific, general, W, system_params):
    base_dict = {
        "alpha": 0.3,
        "lambda_": 0.1,
        "learning_rate": 0.01,
...
def createCNeuralPHEDict(specific, general, W, system_params):
    base_dict = {
        "alpha": 0.3,
        "lambda_": 0.1,
        "learning_rate": 0.01,
...
def createCNeuralUCBDict(specific, general, W, system_params):
    base_dict = {
        "alpha": 0.3,
        "lambda_": 0.1,
        "learning_rate": 0.01,
