    ...
    def runAlgorithms(self, algorithms, diffLists):
        ...
        def printWrite():
            ...
            for alg_name, alg in algorithms.items():
                ...
                print(
                    alg_name,
                    algCTR / randomLearnCTR,
                    algCTR,
                    alg.learn_stats.accesses,
                    alg.learn_stats.clicks,
                )
            # write to file
        ...
        for dataDay in dataDays:
            ...
            fileName = (
                Yahoo_address
                + "/ydata-fp-td-clicks-v1_0.200905"
                + dataDay
                + "."
                + str(userNum)
                + ".userID"
                ...
                for i, line in enumerate(f, 1):
                    ...
                    for article in pool_articles:
                        ...
                        combined_featureVector = np.outer(
                            article_featureVector, user_featureVector
                        ).flatten()
...
def plot_results(algorithms, random):
    ...
    for alg_name, alg in algorithms.items():
        ...
        alg_normalized_CTR = [
            alg_CTR / rand_CTR
            for alg_CTR, rand_CTR in zip(alg_CTR_list, random_CTR_list)
        ]
